		...
		<div>
			...
			<div className={styles.blogContainer} ref={target}>
				...
				<div className={styles.blogContainer__blogBigImage}>
					<img src={state.blogImageUrl} alt={state.blogImageAlt} alt="estimated-time-icon" />
				</div>
			...
			{state.blogCardsArr.map((blog) => (
				<BlogCard
					blogUrl={blog.blogLink}
					imageUrl={blog.blogImageUrl}
					imageAlt={blog.blogImageAlt}
					title={blog.title}
					subTitle={blog.subTitle}
					publishedText={blog.publishedText}
